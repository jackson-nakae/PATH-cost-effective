...
def ce_select_sites_2(data, treatments, treatment_cost, treatment_quantity, fixed_cost, sdyd_threshold, sddc_threshold, slope_range=(None), bs_threshold=(None)):
    ...
    return treatment_cost_vectors, sediment_yield_reduction_thresholds, selected_hillslopes, treatment_hillslopes, total_Sddc_reduction, final_Sddc, hillslopes_sdyd, sdyd_df, untreatable_sdyd, total_cost, total_fixed_cost
...
def path_data_ag(hillslope_data, outlet_data, hillslope_char_data):
    ...
    required_hillslope_columns = ['WeppID', 'TopazID', 'Landuse', 'Soil', 'Length (m)','Hillslope Area (ha)', 'Runoff (mm)', 'Lateral Flow (mm)','Baseflow (mm)', 'Soil Loss (kg/ha)', 
                                  'Sediment Deposition (kg/ha)','Sediment Yield (kg/ha)', 'scenario', 'Runoff (m^3)','Lateral Flow (m^3)', 'Baseflow (m^3)', 'Soil Loss (t)',
                                  'Sediment Deposition (t)', 'Sediment Yield (t)', 'NTU (g/L)']
    required_outlet_data_columns = ['key', 'v', 'units', 'control_scenario', 'contrast_topaz_id','contrast', '_contrast_name', 'contrast_id', 'control_v','control_units', 'control-contrast_v']
    required_hillslope_char_columns = ['slope_scalar', 'length', 'width', 'direction', 'aspect', 'area','elevation', 'centroid_px', 'centroid_py', 'centroid_lon','centroid_lat', 'wepp_id', 'TopazID']
